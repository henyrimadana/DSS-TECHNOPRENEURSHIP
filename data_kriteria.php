...
<body>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item active bg-dark" href="data_kriteria.php">Kriteria</a>
    ...
    <div class="container">
        <h1 class="text-center pt-4 mt-3">Data Kriteria</h1>
    </div>
    <hr>
    <?php
    include "config.php";
    $alternatif = "SELECT * FROM kriteria";
    ...
    <div class="main-1">
        <div class="container">
            ...
            <a href="form_kriteria.php"><button class="btn btn-dark">Tambah Data</button></a>
        </div>
    </div>
</body>
