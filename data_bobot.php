...
<body>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item active bg-dark" href="data_bobot.php">Bobot</a>
    ...
    <div class="container">
        <h1 class="text-center py-4 mt-3">Data Bobot</h1>
    </div>
    <hr>

    <?php
    include "config.php";
    // $bobot = "SELECT * FROM bobot INNER JOIN kriteria ON kriteria.idkriteria = kriteria.idkriteria ORDER BY idbobot, nmkriteria";
    $bobot = "SELECT idbobot, nmkriteria, value FROM bobot JOIN kriteria ON kriteria.idkriteria = bobot.idkriteria";
    $koneksi = $con->query($bobot);
    $no = 1;
    ?>
    <div class="main-1">
        <div class="container">
            <table class="table table-dark table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-center">Id Bobot</th>
            ...
            <a href="form_bobot.php"><button class="btn btn-dark">Tambah Data</button></a>
        </div>
    </div>
</body>
