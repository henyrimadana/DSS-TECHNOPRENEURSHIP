...
<body>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item active bg-dark" href="data_skala.php">Skala</a>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <div class="container">
        <h1 class="text-center pt-4 mt-3">Data Skala </h1>
    </div>
    <hr>
    <?php
    include "config.php";
    $skala1 = "SELECT * FROM skala";
    $koneksi = $con->query($skala1);
    $no = 1;
    ?>
    <div class="main-1">
        <div class="container">
            ...
            <a href="form_skala.php"><button class="btn btn-dark">Tambah Data</button></a>
        </div>
    </div>
